...
background = pygame.image.load("practice_11/racer/images/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("practice_11/racer/images/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemies_group):
        super().__init__()
        try:
            self.image = pygame.image.load("practice_11/racer/images/coin.png")
        except:
            self.image = pygame.Surface((30, 30)); self.image.fill((255, 215, 0))
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("practice_11/racer/images/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('practice_11/racer/sounds/crash.wav').play()
          time.sleep(0.5)
